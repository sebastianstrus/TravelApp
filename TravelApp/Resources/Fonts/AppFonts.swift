...
struct AppFonts {
    static let TITLE_FONT = UIFont(name: "Lemonada-Bold", size: 30)
    static let TITLE_FONT_OLD = UIFont(name: "Boogaloo-Regular", size: Device.IS_IPHONE ? 90 : 180)
    static let SUBTITLE_FONT = UIFont(name: "Boogaloo-Regular", size: Device.IS_IPHONE ? 40 : 80)
    static let BTN_FONT = UIFont(name: "Boogaloo-Regular", size: Device.IS_IPHONE ? 26 : 52)
