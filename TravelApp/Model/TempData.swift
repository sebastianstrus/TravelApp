...
class TempData {
    ...
    class func getVouchers() -> [VoucherTemp]{
        ...
        return [
            VoucherTemp(title: "Voucher1"),
            VoucherTemp(title: "Voucher2"),
            VoucherTemp(title: "Voucher3"),
            VoucherTemp(title: "Voucher4"),
            VoucherTemp(title: "Voucher5"),
            VoucherTemp(title: "Voucher6"),
            VoucherTemp(title: "Voucher7"),
            VoucherTemp(title: "Voucher8"),
            VoucherTemp(title: "Voucher9"),
            VoucherTemp(title: "Voucher1"),
            VoucherTemp(title: "Voucher2"),
            VoucherTemp(title: "Voucher3"),
            VoucherTemp(title: "Voucher4"),
